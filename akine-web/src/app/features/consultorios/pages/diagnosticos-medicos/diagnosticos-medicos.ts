...
@Component({
  ...
  template: `
    <div class="page">
      <div class="header">
        <div>
          <h3>Diagnosticos medicos</h3>
          <p>Maestro clasificado por tipo y categoria para historia clinica y prescripciones.</p>
        </div>
        <div class="actions">
      ...
      @if (loading()) {
        ...
        <div class="filters">
          ...
          <button class="btn-primary" (click)="openCreate()">Agregar diagnostico</button>
        </div>
